...
} # this is a document in MongoDB (NOSQL)
...
#collection.insert_many(list_of_records) #insert many data
#collection.insert_one(data1) #insert data

collection1 = database['dpkt']
#collection1.insert_one(data1) #insert data
